...
public class Criar
{
  ...
  public static ItemStack add(Material m, String nome, int durability , List<String> lore)
  {
    ItemStack item = new ItemStack(m);
    item.setDurability((short)durability);
    ItemMeta meta = item.getItemMeta();
  ...
  public static ItemStack couroHelment(Color cor, String nome)
  {
  ...
  public static ItemStack couroChestplate(Color cor, String nome)
  {
    ItemStack item = new ItemStack(Material.LEATHER_CHESTPLATE);
    LeatherArmorMeta meta = (LeatherArmorMeta)item.getItemMeta();
    meta.setColor(cor);
  ...
  public static ItemStack couroLeggings(Color cor, String nome)
  {
  ...
  public static ItemStack couroBoots(Color cor, String nome)
  {
  ...
  public static ItemStack getNamedSkull(String nick, String nome, String[] lore, Enchantment enchant, Integer level)
  {
    @SuppressWarnings("deprecation")
	ItemStack skull = new ItemStack(397, 1, (short)3);
    skull.addUnsafeEnchantment(enchant, level);
